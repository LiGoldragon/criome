...
impl Witness {
    ...
    fn configure_auto_approve(&self) {
        ...
        eprintln!("criome-auto-approve-witness-test: PROOF (1) meta Configure(AutoApprove) -> Configured");
    }
    ...
    fn run(&self) {
        ...
        println!("criome-auto-approve-witness-test: OK (meta Configure applied, auto-approve authorizes)");
    }
}
